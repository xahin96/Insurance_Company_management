...
<body>
<center><h1><a href="date.php"><font size="3" color="red">Back</font><a/></h1></center>
<center><h1>Accidents Between <?php echo"$date1 AND $date2";?></h1><a href="add.php"><font size="3" color="red">"If Accident Not Exist Click here"</font><a/></center>
<table class="bordered">
    ...
    <?php
      $stid=oci_parse($conn,"select ACCNO,OWNERID,ACCDATE,NAME FROM ACCIDENT,PERSON WHERE ACCDATE BETWEEN $date1 AND $date2 AND PID=OWNERID");
      oci_execute($stid);
      $counter=1;
      $date="Not Avaliable";
