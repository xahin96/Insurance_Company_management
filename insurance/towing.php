...
require 'style.php';
 /*if(isset($_POST['add'])){
      ...
      if(isset($_POST['towphone'])){
       ...
       $sql="insert into TOWINGCOMP (TNO,TCOMPNAME,PHONENO)VALUES
($towingno,'$towingname','$phone')";
	  ...
	  <tr>
		...
		<td valign="top" width="455" class="m2bg">
			...
			<table width="438" border="0" cellspacing="0" cellpadding="0">
			 <form  id="Addnew" method="post" action="add_towing_handler.php">
	    <h1>Add Towing Company</h1>
	<fieldset id="inputs">
	   	<fieldset>Towing Number</br><input  type="text" name="towno" required="required"  /></fieldset></br>
		<fieldset>Towing Name </br><input type="text" name="towname" required="required" /></fieldset></br>
        <fieldset>Phone </br><input type="text" name="towphone"  /></fieldset></br>
                               <fieldset id="actions">
        <input class="myButton" name="add" onclick="if(!validation())return false;" type="submit" value="Add Towing" />
    </fieldset>
</form>
			</table>
		</td>
